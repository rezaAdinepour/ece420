...
HD_PWD='/mnt/9636D17436D15639/Tutorial/FPGA/VHDL/ece420/Codes/Adders/Intiger_Adder/Intiger_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log int_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source int_adder.tcl
